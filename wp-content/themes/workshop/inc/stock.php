...
class WS_Stock {
    ...
    public static function stock_rows( $args = array() ) {
        ...
        $sql = "SELECT s.*, p.name, p.barcode, p.category, p.category_id, p.min_stock, p.sale_price, p.cost_price, p.transfer_pct, p.currency, p.show_equiv, p.image, p.description, p.store_visible,

...
(function() {
    ...
    var WS_PANEL_PAGES = ['dashboard','products','locations','stock','movements','orders','shifts','workers','permissions','reports','settings','account','appearance','customers','reviews','loyalty','pos','pos-sales','plan','anuncios','expenses'];
